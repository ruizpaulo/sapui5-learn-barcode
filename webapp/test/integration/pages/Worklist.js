		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("Barcode"),
								name: oBindingContext.getProperty("Barcode")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all BarScanners to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "BarScanners",
