sap.ui.define([
	"sap/ui/test/Opa5",
	"pruiz/barcode_76/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"pruiz/barcode_76/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("pruiz.barcode_76.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "BarScanners/" + encodeURIComponent(sObjectId);
